...
<div class="rowGame">
    ...
    <span class="Record"><asp:Label ID="lblAwayRecord" runat="server" Text="0-0"></asp:Label></span>
    ...
    <span class="Record"><asp:Label ID="lblHomeRecord" runat="server" Text="0-0"></asp:Label></span>
