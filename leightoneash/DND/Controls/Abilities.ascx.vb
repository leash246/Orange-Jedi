...
#End Region
    ...
    End Sub
    Public Sub InitDefaults(nCharID As Integer)
        FillDropDowns()
        ...
        Try
            ...
            If dt.Rows.Count = 1 Then
                ...
                ddlStr.SelectedValue = dr.Item("nStrAbilityScore")
                ddlDex.SelectedValue = dr.Item("nDexAbilityScore")
                ddlCon.SelectedValue = dr.Item("nConAbilityScore")
                ddlInt.SelectedValue = dr.Item("nIntAbilityScore")
                ddlWis.SelectedValue = dr.Item("nWisAbilityScore")
                ddlCha.SelectedValue = dr.Item("nChaAbilityScore")
            End If
